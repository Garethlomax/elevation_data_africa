...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  6 16:24:45 2021
...
df = pd.read_csv("data/ged201.csv")
...
# plt.plot(df.longitude.head(), df.latitude.head(), 'o', transform = transform)
plt.plot( df.longitude, df.latitude,'o', transform = ccrs.Geodetic(), alpha = 0.1)
